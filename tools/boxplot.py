...
fast_one = pd.read_csv('output/chart_v0/FAST-one-bbox.tsv', sep='\t')
#fast_time = pd.read_csv('output/chart_v0/FAST-time-bbox.tsv', sep='\t')
fast_pw = pd.read_csv('output/chart_v0/FAST-pw-bbox.tsv', sep='\t')
